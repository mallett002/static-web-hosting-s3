...
export class VerdadeStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);
      ...
      new route53.ARecord(this, 'rootDomainAliasRecord', {
        target: route53.RecordTarget.fromAlias(new targets.CloudFrontTarget(cloudFrontDistributions.rootDomainDistribution)),
        zone: route53Construct.hostedZone,
        recordName: '',
      });
